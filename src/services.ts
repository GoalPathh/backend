...
export class DashboardService { constructor(private repo=new DashboardRepository()){} today(u:string){return this.repo.today(u)} progress(u:string){return this.repo.progress(u)} setCompletion(u:string,id:string,c:boolean,d?:string){return this.repo.setCompletion(u,id,c,d)} }
